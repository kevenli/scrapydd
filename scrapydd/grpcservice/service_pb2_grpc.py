...
class NodeService(object):
    ...
    def Login(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NodeService/Login',
            scrapydd_dot_grpcservice_dot_service__pb2.LoginRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.LoginResponse.FromString,
    ...
    def Heartbeat(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NodeService/Heartbeat',
            scrapydd_dot_grpcservice_dot_service__pb2.HeartbeatRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.HeartbeatResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetNextJob(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NodeService/GetNextJob',
            scrapydd_dot_grpcservice_dot_service__pb2.GetNextJobRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.GetNextJobResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetJob(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NodeService/GetJob',
            scrapydd_dot_grpcservice_dot_service__pb2.GetJobRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.GetJobResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetEgg(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NodeService/GetEgg',
            scrapydd_dot_grpcservice_dot_service__pb2.GetJobEggRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.GetJobEggRequest.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def CompleteJob(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/NodeService/CompleteJob',
            scrapydd_dot_grpcservice_dot_service__pb2.CompleteJobRequest.SerializeToString,
            scrapydd_dot_grpcservice_dot_service__pb2.CompleteJobResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
