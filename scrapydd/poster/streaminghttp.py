...
"""
from six.moves.http_client import NotConnected, HTTPConnection
from six.moves.urllib.request import Request, HTTPRedirectHandler, HTTPHandler, HTTPSHandler, build_opener, \
    install_opener
...
if hasattr(six.moves.http_client, 'HTTPS'):
...
if hasattr(six.moves.http_client, 'HTTPSConnection'):
